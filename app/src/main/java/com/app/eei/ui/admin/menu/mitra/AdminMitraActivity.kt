package com.app.eei.ui.admin.menu.mitra
...
class AdminMitraActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAdminMitraBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_admin_mitra)

        binding = ActivityAdminMitraBinding.inflate(layoutInflater)
        ...
        viewmodel.getNewsByType().observe(this, { data ->
            ...
            berandaListAdapter.setOnItemClickCallback(object :
                ...
                override fun onItemClicked(data: News) {
                    Toast.makeText(this@AdminMitraActivity, data.title, Toast.LENGTH_SHORT).show()
                    val intent = Intent(this@AdminMitraActivity, AdminDetailActivity::class.java)
