package com.app.eei.ui.admin.menu.berita
...
class AdminNewsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAdminNewsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAdd.setOnClickListener {
            ...
            intent.putExtra("type",getString(R.string.berita))
        ...
        viewmodel.getNewsByType().observe(this, { data ->
            ...
            berandaListAdapter.setOnItemClickCallback(object :
                ...
                override fun onItemClicked(data: News) {
                    Toast.makeText(this@AdminNewsActivity, data.title, Toast.LENGTH_SHORT).show()
