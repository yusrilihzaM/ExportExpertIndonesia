package com.app.eei.ui.guest.menu.event
...
import com.app.eei.databinding.ActivityGuestEventBinding
...
class GuestEventActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGuestEventBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGuestEventBinding.inflate(layoutInflater)
        ...
        viewmodel.getNewsByType().observe(this, { data ->
            ...
            berandaListAdapter.setOnItemClickCallback(object :
                ...
                override fun onItemClicked(data: News) {
                    Toast.makeText(this@GuestEventActivity, data.title, Toast.LENGTH_SHORT).show()
                    val intent = Intent(this@GuestEventActivity, GuestDetailActivity::class.java)
