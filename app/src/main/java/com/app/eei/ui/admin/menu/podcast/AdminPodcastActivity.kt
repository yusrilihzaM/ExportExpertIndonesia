package com.app.eei.ui.admin.menu.podcast
...
class AdminPodcastActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAdminPodcastBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_admin_podcast)

        binding = ActivityAdminPodcastBinding.inflate(layoutInflater)
        ...
        viewmodel.getNewsByType().observe(this, { data ->
            ...
            berandaListAdapter.setOnItemClickCallback(object :
                ...
                override fun onItemClicked(data: News) {
                    Toast.makeText(this@AdminPodcastActivity, data.title, Toast.LENGTH_SHORT).show()
