package com.app.eei.ui.guest.menu.tips
...
import com.app.eei.databinding.ActivityGuestTipsBinding
...
class GuestTipsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGuestTipsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_guest_tips)

        binding = ActivityGuestTipsBinding.inflate(layoutInflater)
        setContentView(binding.root)
        val upArrow = resources.getDrawable(R.drawable.ic_baseline_arrow_back_ios_24)
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        supportActionBar?.setHomeAsUpIndicator(upArrow)
        supportActionBar?.title = Html.fromHtml("<font color=\"black\">" + getString(R.string.tipsdantricks) + "</font>")
        ...
        viewmodel.getNewsByType().observe(this, { data ->
            ...
            berandaListAdapter.setOnItemClickCallback(object :
                ...
                override fun onItemClicked(data: News) {
                    Toast.makeText(this@GuestTipsActivity, data.title, Toast.LENGTH_SHORT).show()
                    val intent = Intent(this@GuestTipsActivity, GuestDetailActivity::class.java)
