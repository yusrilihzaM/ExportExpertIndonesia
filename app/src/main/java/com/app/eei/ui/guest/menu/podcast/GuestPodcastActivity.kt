package com.app.eei.ui.guest.menu.podcast
...
import com.app.eei.databinding.ActivityGuestPodcastBinding
...
class GuestPodcastActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGuestPodcastBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_guest_podcast)
        binding = ActivityGuestPodcastBinding.inflate(layoutInflater)
    ...
    private fun showData() {
        ...
        viewmodel.setNewsByType("Podcast")
        viewmodel.getNewsByType().observe(this, { data ->
            ...
            berandaListAdapter.setOnItemClickCallback(object :
                ...
                override fun onItemClicked(data: News) {
                    Toast.makeText(this@GuestPodcastActivity, data.title, Toast.LENGTH_SHORT).show()
                    val intent = Intent(this@GuestPodcastActivity, AdminDetailActivity::class.java)
