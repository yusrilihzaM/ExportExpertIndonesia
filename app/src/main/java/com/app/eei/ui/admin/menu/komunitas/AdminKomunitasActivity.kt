package com.app.eei.ui.admin.menu.komunitas
...
class AdminKomunitasActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAdminKomunitasBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_admin_komunitas)

        binding = ActivityAdminKomunitasBinding.inflate(layoutInflater)
    ...
    private fun showData() {
        ...
        viewmodel.setNewsByType("Komunitas")
        viewmodel.getNewsByType().observe(this, { data ->
            ...
            berandaListAdapter.setOnItemClickCallback(object :
                ...
                override fun onItemClicked(data: News) {
                    Toast.makeText(this@AdminKomunitasActivity, data.title, Toast.LENGTH_SHORT).show()
