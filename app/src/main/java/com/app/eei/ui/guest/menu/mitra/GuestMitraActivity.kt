package com.app.eei.ui.guest.menu.mitra
...
import com.app.eei.databinding.ActivityGuestMitraBinding
...
class GuestMitraActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGuestMitraBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_guest_mitra)
        binding = ActivityGuestMitraBinding.inflate(layoutInflater)
        ...
        viewmodel.getNewsByType().observe(this, { data ->
            ...
            berandaListAdapter.setOnItemClickCallback(object :
                ...
                override fun onItemClicked(data: News) {
                    Toast.makeText(this@GuestMitraActivity, data.title, Toast.LENGTH_SHORT).show()
                    val intent = Intent(this@GuestMitraActivity, GuestDetailActivity::class.java)
