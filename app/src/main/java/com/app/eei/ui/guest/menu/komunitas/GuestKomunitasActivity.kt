package com.app.eei.ui.guest.menu.komunitas
...
import com.app.eei.databinding.ActivityGuestKomunitasBinding
...
class GuestKomunitasActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGuestKomunitasBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_guest_komunitas)

        binding = ActivityGuestKomunitasBinding.inflate(layoutInflater)
